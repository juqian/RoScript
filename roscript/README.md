...
(2) [*Optional*] Configure for virtual debugging mode (Need not real robot to run)

Copy `demo\Iphone5S\iOS-Sys\config` to folder config `config` to recover the debugging enviornment.
