...
class RcsLogger(object):
    ...
    def record_TM_result(self, match_result):
        ...
        TM_message = ("template match, number: {}, time: {:.2f}s, "
                      "similarity: {:.2f}, coordinates: [{}, {}]"
                      .format(self.TM_idx, TM_exec_time,
                              match_result.similarity, x, y))
    ...
    def record_TP_result(self):
        ...
        TP_message = ("take photo, number: {}, time: {:.2f}s, "
                      "total time: {:.2f}s"
                      .format(self.TP_idx, TP_exec_time, self.TP_total_time))
