from roscript_recorder.processors import device_detector, finger_detector
...
class Frame:
    ...
    def get_fingertip(self, hand_colors, backgrounds, dev_location, dev_real_measure, pixel_to_real_ration):
        ...
        if isinstance(self.overlook_image, numpy.ndarray):
            ...
            overlook_fingertip_position = finger_detector.YCrCb_overlook_fingertip_detect(self.overlook_image,
                        background, hand_color_low, hand_color_high, dev_location, dev_real_measure, pixel_to_real_ration)
        ...
        if isinstance(self.sidelook_image, numpy.ndarray):
            ...
            sidelook_fingertip_position = finger_detector.YCrCb_sidelook_fingertip_detect(self.sidelook_image,
                        background, hand_color_low, hand_color_high, dev_real_measure, pixel_to_real_ration)
