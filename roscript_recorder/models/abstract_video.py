...
import os
import numpy as np
from roscript_recorder.processors import group_processor
from roscript_recorder.constants import *

class AbstractVideo:
    def __init__(self, path, device_real_measure, keyboards_dir=None):
        self.path = path
    ...
    def get_actions(self):
        ...
        if AUTO_HAND_COLOR_DETECT:
            ...
            self.hand_colors["overlook_low"] = (SKIN_Y_LOW, SKIN_CR_LOW, SKIN_CB_LOW)
            self.hand_colors["overlook_high"] = (SKIN_Y_HIGH, SKIN_CR_HIGH, SKIN_CB_HIGH)
            self.hand_colors["sidelook_low"] = (SKIN_Y_LOW, SKIN_CR_LOW, SKIN_CB_LOW)
            self.hand_colors["sidelook_high"] = (SKIN_Y_HIGH, SKIN_CR_HIGH, SKIN_CB_HIGH)
    ...
    def get_fingertips(self):
        ...
        while True:
            ...
            fingertip = frame.get_fingertip(self.hand_colors, backgrounds, dev_location, self.device_real_measure, pixel_to_real_ratio)
