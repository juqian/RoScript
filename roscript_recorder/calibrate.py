...
def calc_skin_color_range(yCrCb_colors):
    ...
    # a = (Y_median - SKIN_COLOR_EXTENDS - 25, Cr_median- SKIN_COLOR_EXTENDS - 5, Cb_median - SKIN_COLOR_EXTENDS)
    # b = (Y_median + SKIN_COLOR_EXTENDS + 25, Cr_median + SKIN_COLOR_EXTENDS + 5, Cb_median + SKIN_COLOR_EXTENDS)
